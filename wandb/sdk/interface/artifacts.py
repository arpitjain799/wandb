...
from wandb.sdk.lib.filesystem import StrPath, check_available_space, mkdir_exists_ok
...
class ArtifactsCache:
    ...
    def __init__(self, cache_dir: StrPath) -> None:
        ...
        self._reserve_bytes = env.get_minimum_free_space(default=1_000_000_000)
